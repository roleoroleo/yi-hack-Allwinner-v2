...
void print_usage(char *progname)
{
    ...
    fprintf(stderr, "\t\tset model: y21ga, y211ga, y291ga, y291ge, h30ga, r30gb, r35gb, r40ga, h51ga, h52ga, h60ga, y28ga, y29ga, q321br_lsx, qg311r or b091qp (default y21ga)\n");
...
int main(int argc, char** argv)
{
    ...
    if (str != NULL) {
        if (strcasecmp("y21ga", str) == 0) {
            ...
            model = Y291GA;
        } else if (strcasecmp("y291ge", str) == 0) {
            model = Y291GE;        
