...
if [ "${SUFFIX}" = "r30gb" ] || [ "${SUFFIX}" = "qg703" ]|| [ "${SUFFIX}" = "q705br" ]|| [ "${SUFFIX}" = "q705ssv" ]|| [ "${SUFFIX}" = "qg305r" ]|| [ "${SUFFIX}" = "qg380r" ]|| [ "${SUFFIX}" = "q381br" ]|| [ "${SUFFIX}" = "r31gb" ]|| [ "${SUFFIX}" = "lyr30" ]|| [ "${SUFFIX}" = "r33gb" ];then
...
elif [ "${SUFFIX}" = "b111qp" ] ||  [ "${SUFFIX}" = "b091qp" ];then
